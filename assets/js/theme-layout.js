import {
  ...
  suppressThemePack
} from './theme.js?v=press-system-v3.4.123';
import {
  t,
  withLangParam,
  getCurrentLang,
  ...
  getAvailableLangs,
  getLanguageLabel
} from './i18n.js?v=press-system-v3.4.123';
import {
...
const NATIVE_MODULE_CACHE_KEY = 'press-system-v3.4.123';
