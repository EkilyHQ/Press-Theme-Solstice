import { createStagingRegistry } from './composer-staging.js?v=press-system-v3.4.53';
import { createIndexPublishMetadataEnricher } from './composer-index-publish-metadata.js?v=press-system-v3.4.53';
import { createContentCommitStagingProvider } from './composer-content-staging.js?v=press-system-v3.4.53';
import { createSeoStagingProvider } from './composer-seo-staging.js?v=press-system-v3.4.53';
import { createPostCommitStateApplier } from './composer-post-commit-state.js?v=press-system-v3.4.53';
