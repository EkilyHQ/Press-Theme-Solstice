import { createStagingRegistry, normalizeStagingWarning } from './composer-staging.js?v=press-system-v3.4.127';
import { createIndexPublishMetadataEnricher } from './composer-index-publish-metadata.js?v=press-system-v3.4.127';
import { createContentCommitStagingProvider } from './composer-content-staging.js?v=press-system-v3.4.127';
import { createSeoStagingProvider } from './composer-seo-staging.js?v=press-system-v3.4.127';
import { createPostCommitStateApplier } from './composer-post-commit-state.js?v=press-system-v3.4.127';
