...
import { getCurrentLang, DEFAULT_LANG, getAvailableLangs } from './i18n.js?v=press-system-v3.4.139';
import { parseFrontMatter } from './content.js?v=press-system-v3.4.139';
import { isSiteFeatureEnabled } from './site-features.js?v=press-system-v3.4.139';
import { buildLanguageAvailability, collectContentLanguages, normalizeLanguageCode } from './language-availability.js?v=press-system-v3.4.139';
