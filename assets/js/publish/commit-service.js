...
} from './transports/connect-transport.js?v=press-system-v3.4.130';
...
export async function publishCommit({
  ...
  emitPublishState(onPublishState, 'committing');
  const { createFineGrainedTokenCommit } = await import('./transports/github-pat-transport.js?v=press-system-v3.4.130');
